...
export function Fashion() {
  ...
  useEffect(() => {
    api.getProducts({ category: "Fashion" }).then((res) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <section className="relative h-[50vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-black">
        <div className="text-center px-4 max-w-4xl mx-auto">
          ...
          >
            Curated style essentials for the modern wardrobe. Elevate your everyday.
          </motion.p>
        </div>
      </section>
